...
||  ($controller=='rice' && ($action == 'index_riceSpecies' ||  $action == 'index_riceDisease' || $action == 'index_ricePathogen' || $action == 'addPathogen' || $action =='updatePathogen' || $action == 'index_riceDiseasePathogen'))
