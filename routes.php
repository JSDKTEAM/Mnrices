...
||  ($controller=='rice' && ($action == 'index_riceSpecies'|| $action == 'insert'|| $action == 'update' ||  $action == 'index_riceDisease' || $action == 'index_ricePathogen' || $action == 'addPathogen' || $action =='updatePathogen'))
